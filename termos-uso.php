<?php 
	$title = "The Nat Company | Termos de Uso";

	include "header.php";
?>

	<div class="contentTermosUso">
		<div class="termosUso">
			<h2>Termos de Uso</h2>

			<h3>Visão Geral</h3>
			<p>Esse site é operado pela The Nat Company. Em todo o site, os termos “nós”, “nos” e “nosso” se referem a The Nat Company. O The Nat Company proporciona esse site, incluindo todas as informações, ferramentas e serviços disponíveis deste site para você, o usuário, com a condição da sua aceitação de todos os termos, condições, políticas e avisos declarados aqui.</p>
			...
			<h3>Seção 3 - Precisão, Integridade e Atualização das Informação</h3>
			...
			<h3>Seção 5 - Produtos</h3>
			<p>Certos produtos podem estar disponíveis exclusivamente online através do site. Tais produtos podem ter quantidades limitadas e são sujeitos a apenas devolução ou troca, de acordo com nossa Política de devolução.</p>
			...
			<h3>Seção 13 - Isenção de Responsabilidade de Garantias; Limitação de Responsabilidades</h3>
			...
			<h3>Seção 18 - Alterações dos Termos de Serviço</h3>
			...
			<h3>Seção 19 - Informações de Contato</h3>
			<p>As perguntas sobre os Termos de serviço devem ser enviadas para nós através do contato@thenatcompany.com.br.</p>
		</div>
